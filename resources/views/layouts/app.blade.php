...
<head>
    ...
    <title>سامانه تهیه لیست با‌من‌بخوان</title>
...
<body id="app-layout">
    ...
    <footer class="hidden-print website-footer">
        <p><a href="https://github.com/dahdash/khanak-list"><i class="fa fa-btn fa-github"></i></a>سامانه تهیه لیست با‌من‌بخوان</p>
    </footer>
